...
async function showCategoryMenu(client, m, categoryNumber, prefix) {
    const categoriesList = [
        ...
        { num: 8, name: "SONG", image: " https://tmpfiles.org/dl/wlw7dY2rDdQQ/file_1782010685476.jpeg", icon: "🎵", keywords:["song", "music", "mp3", "bass", "slow", "nightcore", "find", "audio", "spotify", "ytmp3", "lyrics"] }
    ];
